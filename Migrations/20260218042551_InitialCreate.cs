...
namespace CleanMvcApp.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryRadius = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    OpeningTime = table.Column<TimeSpan>(type: "time", nullable: false),
                    ClosingTime = table.Column<TimeSpan>(type: "time", nullable: false),
                    DeliveryCharge = table.Column<decimal>(type: "decimal(10,2)", nullable: false, defaultValue: 0m),
                    StoreImageUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "Pending"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_Review_Target", "(StoreId IS NOT NULL AND ProductId IS NULL) OR (StoreId IS NULL AND ProductId IS NOT NULL)");
                    table.ForeignKey(
